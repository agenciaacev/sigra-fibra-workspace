  ...
  return (
    <div data-aos="fade-up" data-aos-delay={index * 60}
      ...
      >
        ...
        <div className={`w-8 h-8 rounded-xl flex items-center justify-center shrink-0 transition-all duration-200 text-white`}
      ...
      <div className="max-w-[800px] mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="text-center mb-14">
          ...
          <p data-aos="fade-up" data-aos-delay="120" className="text-gray-500 mt-4 leading-relaxed">
            Posso usar em vários dispositivos? Já tinha uma conta? Quanto tempo leva? Respondemos tudo abaixo.
          </p>
        </div>
