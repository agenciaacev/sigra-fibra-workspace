...
const passos = [
  { num: '01', title: 'Acesse o e-mail', desc: 'Verifique o e-mail recebido da Siga Fibra com suas credenciais.' },
  { num: '02', title: 'Clique em ativar', desc: 'Toque no botão de ativação destacado no e-mail recebido.' },
  { num: '03', title: 'Informe o site da Globo', desc: 'Acesse o link indicado e insira seu e-mail cadastrado.' },
  { num: '04', title: 'Faça login e assista!', desc: 'Entre na sua conta e o entretenimento começa agora.' },
]

export default function ComoAcessarGloboPlay() {
    ...
    <section className="py-14 md:py-24 relative overflow-hidden" style={{ background: '#27CAA3' }}>
      ...
      <div className="max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <p data-aos="fade-up" className="text-xs font-bold uppercase tracking-widest mb-3 text-white opacity-70">
            Simples assim
          </p>
          <h2 data-aos="fade-up" data-aos-delay="60"
            className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white leading-tight">
            Entenda como é fácil acessar o Globoplay.
          </h2>
        </div>
        ...
        <div data-aos="fade-up" data-aos-delay="200"
          ...
          <span className="text-sm text-white opacity-40">4 mockups de celular — passo a passo de ativação Globoplay</span>
        </div>

        <div data-aos="fade-up" data-aos-delay="260" className="text-center">
          <button
            onClick={() => navigate('/pessoa-fisica/atendimento/canais')}
            className="font-bold px-12 py-4 rounded-2xl text-sm uppercase tracking-wide bg-white transition-all duration-200"
            style={{ color: '#27CAA3' }}
