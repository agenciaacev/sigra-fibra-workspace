...
export default function DorLinkDedicado() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div data-aos="fade-right" className="relative">
            <div className="w-full aspect-[4/3] rounded-3xl overflow-hidden flex flex-col items-center justify-center gap-3"
              ...
              <span className="text-xs text-gray-600">Foto de profissional frustrado / lento</span>
            </div>
          ...
          <div>
            ...
            <p data-aos="fade-up" data-aos-delay="120"
              ...
              Quando você compartilha banda, compartilha também instabilidade. Com o Link Dedicado, sua empresa tem uma conexão exclusiva, sem concorrência de outros usuários, disponível 24 horas por dia.
            </p>

            {/* Pain points */}
            <div data-aos="fade-up" data-aos-delay="180" className="flex flex-col gap-3 mb-10">
              {[
                'Videoconferências travando na hora errada',
                'Sistema em nuvem lento durante pico de uso',
                'Upload de arquivos que demora horas',
                'Quedas de conexão sem aviso',
              ].map((pain, i) => (
