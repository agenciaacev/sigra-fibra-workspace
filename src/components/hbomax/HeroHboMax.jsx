...
export default function HeroHboMax() {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden"
      ...
      {/* HBO Max purple glow */}
      <div className="absolute -top-32 right-0 w-[700px] h-[700px] rounded-full opacity-30 pointer-events-none"
      ...
      {/* Foto placeholder fullwidth */}
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 opacity-30"
        style={{ background: 'linear-gradient(90deg, rgba(13,0,31,0.98) 45%, rgba(13,0,31,0.2) 100%)' }} />
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 -z-10"
        style={{ background: '#0d001f' }}>
