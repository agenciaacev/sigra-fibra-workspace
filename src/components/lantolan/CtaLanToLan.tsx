          ...
          <div>
            ...
            <div data-aos="fade-up" data-aos-delay="180" className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                onMouseEnter={(e: React.MouseEvent<HTMLElement>) => (e.currentTarget as HTMLElement).style.borderColor = '#fff'}
                onMouseLeave={(e: React.MouseEvent<HTMLElement>) => (e.currentTarget as HTMLElement).style.borderColor = 'rgba(255,255,255,0.5)'}
              >
                Falar com consultor
              </button>
            </div>
