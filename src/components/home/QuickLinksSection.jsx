  ...
  return (
    <section className="py-12 md:py-20 lg:py-24 bg-white">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        <p className="text-center text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#27CAA3' }}>
          O que você precisa?
        </p>
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {links.map((item) => (
            <button
              ...
              onMouseEnter={e => { e.currentTarget.style.borderColor = '#27CAA3'; e.currentTarget.style.boxShadow = '0 8px 24px rgba(39,202,163,0.12)' }}
