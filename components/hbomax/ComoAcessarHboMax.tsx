...
const passos = [
  { num: '01', title: 'Acesse o app', desc: 'Baixe ou abra o app HBO Max no seu dispositivo.' },
  { num: '02', title: 'Veja os planos', desc: 'Visualize todos os planos disponíveis na tela inicial.' },
  { num: '03', title: 'Selecione Siga Fibra', desc: 'Encontre Siga Fibra em Operadoras Parceiras.' },
  { num: '04', title: 'Pronto!', desc: 'Conclua o acesso e o entretenimento começa agora.' },
]

export default function ComoAcessarHboMax() {
      ...
      <div className="max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 data-aos="fade-up" data-aos-delay="60" className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white leading-tight">
            Acessar o HBO Max pela Siga Fibra é fácil e rápido.
          </h2>
        </div>
        ...
        <div data-aos="fade-up" data-aos-delay="200"
          ...
          <span className="text-sm text-white opacity-40">4 mockups de celular — passo a passo de ativação</span>
        </div>
