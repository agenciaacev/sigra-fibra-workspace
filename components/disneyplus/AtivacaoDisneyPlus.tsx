...
const passos = [
  { num: '01', title: 'Acesse o link', desc: 'Acesse o link de ativação disponível na sua conta Siga Fibra.' },
  { num: '02', title: 'Informe seu número', desc: 'Digite o número do celular cadastrado no seu plano.' },
  { num: '03', title: 'Confirme o SMS', desc: 'Receba e informe o código de verificação por SMS.' },
  { num: '04', title: 'Ative e assista!', desc: 'Pronto — seu Disney+ está ativo. O entretenimento começa agora.' },
]

export default function AtivacaoDisneyPlus() {
      ...
      <div className="max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 data-aos="fade-up" data-aos-delay="60" className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white leading-tight">
            Ativar é simples: 4 passos e você já está assistindo.
          </h2>
        </div>
        ...
        <div data-aos="fade-up" data-aos-delay="200"
          ...
          <span className="text-sm text-white opacity-40">4 mockups de celular — fluxo de ativação Disney+ Siga Fibra</span>
        </div>
