  ...
  return (
    <section className="py-20 md:py-28 relative overflow-hidden" style={{ background: '#060d0f' }}>
      <div className="absolute inset-0 pointer-events-none" style={{
        background: 'radial-gradient(ellipse 60% 80% at 50% 50%, rgba(3,194,195,0.07), transparent)',
      }} />
      <div className="relative max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14" data-aos="fade-up">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4">
            Como contratar o{' '}
            <span style={{ color: '#03C2C3' }}>Siga Fixo Empresarial</span>
          </h2>
            ...
            <div key={i} className="relative">
              ...
              >
                <div className="w-12 h-12 rounded-2xl flex items-center justify-center mb-5 font-black text-sm"
                  style={{ background: 'linear-gradient(135deg, #3ddcde 0%, #03C2C3 100%)', color: '#0f2d22' }}
                >
                  {step.n}
                </div>
        ...
        <div className="rounded-2xl p-6 mb-12" data-aos="fade-up" data-aos-delay="80"
          style={{ background: 'rgba(3,194,195,0.07)', border: '1px solid rgba(3,194,195,0.2)' }}
        >
        ...
        <div className="text-center" data-aos="fade-up">
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a
              href="tel:8531989555"
              className="inline-flex items-center justify-center gap-2 font-semibold px-10 py-4 rounded-2xl text-sm text-gray-300 transition-all duration-200 hover:text-[#03C2C3]"
