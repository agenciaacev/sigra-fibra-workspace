...
export default function HeroMovelEmpresa() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-20 right-0 w-[600px] h-[600px] rounded-full pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(3,194,195,0.16), transparent 65%)' }} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            >
              Chip que{' '}
              <span style={{
                background: 'linear-gradient(135deg, #03C2C3, #06b6d4)',
          ...
          <div data-aos="fade-left" data-aos-delay="180" className="hidden lg:block">
            <div className="relative">
              ...
              <div className="absolute -top-4 -right-4 text-xs font-bold px-4 py-1.5 rounded-full text-white"
                style={{ background: 'linear-gradient(135deg, #03C2C3, #06b6d4)' }}
              >
                Sem fidelidade
              </div>
              <div className="absolute -bottom-4 -left-4 text-xs font-bold px-4 py-1.5 rounded-full"
                style={{ background: '#0f2d22', border: '1px solid rgba(3,194,195,0.3)', color: '#03C2C3' }}
              >
