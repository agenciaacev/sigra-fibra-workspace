...
export default function PortabilidadeSectionEmpresa() {
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14" data-aos="fade-up">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold mb-4" style={{ color: 'var(--text-dark)' }}>
            Mantenha seu número,{' '}
            <span style={{ color: '#03C2C3' }}>mude para a Siga</span>
          </h2>
            ...
            <div key={i} className="relative">
              ...
              >
                <div className="w-12 h-12 rounded-2xl flex items-center justify-center mb-5 font-black text-sm"
                  style={{ background: 'linear-gradient(135deg, #3ddcbc 0%, #03C2C3 100%)', color: '#0f2d22' }}
                >
                  {step.n}
                </div>
