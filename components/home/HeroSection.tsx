      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center relative z-10">
        ...
        <div>
          ...
          <div data-aos="fade-up" data-aos-delay="200" className="flex flex-col sm:flex-row gap-3">
            <button onClick={() => router.push('/pessoa-fisica/internet-fibra')}
            ...
            <button onClick={() => router.push('/pessoa-fisica/atendimento/canais')}
              ...
              onMouseEnter={(e: React.MouseEvent<HTMLElement>) => { (e.currentTarget as HTMLElement).style.borderColor = '#27CAA3'; e.currentTarget.style.color = '#27CAA3' }}
