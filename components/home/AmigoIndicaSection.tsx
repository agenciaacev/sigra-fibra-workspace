    ...
    <section className="py-16 md:py-20 relative overflow-hidden" style={{ background: '#060d0f' }}>
      ...
      <div className="relative max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl overflow-hidden relative"
          style={{ background: 'linear-gradient(135deg, rgba(39,202,163,0.13) 0%, rgba(3,194,195,0.07) 100%)', border: '1.5px solid rgba(39,202,163,0.25)' }}>
          ...
          <div className="p-8 md:p-12 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div data-aos="fade-right">
              ...
              <p className="text-gray-400 leading-relaxed mb-8 max-w-md">
                A cada amigo que contratar a Siga Fibra pela sua indicação, você recebe <strong className="text-white">100% de desconto</strong> em uma mensalidade. Sem complicação.
              </p>

              <button
                onClick={() => router.push('/pessoa-fisica/amigo-indica')}
                className="font-bold px-8 py-4 rounded-2xl text-sm uppercase tracking-wide text-white transition-all duration-200 hover:opacity-90 hover:scale-[1.02] active:scale-95"
            ...
            <div data-aos="fade-left" data-aos-delay="80" className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                { icon: '🎁', value: '100%', label: 'de desconto por indicação confirmada' },
                { icon: '♾️', value: '∞', label: 'sem limite de indicações' },
                { icon: '⚡', value: 'Fácil', label: 'indique pelo app ou site oficial' },
              ].map((card, i) => (
