    ...
    <section className="relative overflow-hidden" style={{ background: '#060d0f' }}>
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        ...
        >
          ...
          <div className="px-5 py-4 flex items-center gap-2" style={{ background: 'rgba(3,194,195,0.1)', borderLeft: '1px solid rgba(3,194,195,0.2)', borderRight: '1px solid rgba(3,194,195,0.2)' }}>
            <span className="w-2 h-2 rounded-full" style={{ background: '#03C2C3' }} />
            <p className="text-xs font-bold uppercase tracking-widest" style={{ color: '#03C2C3' }}>Fibra Siga Empresarial</p>
          </div>
          <div className="px-5 py-4" style={{ background: 'rgba(255,255,255,0.03)' }}>
        ...
        >
          {comparisons.map((row, i) => (
            ...
            >
              ...
              <div className="px-5 py-4 flex items-center gap-2" style={{ background: 'rgba(3,194,195,0.05)', borderLeft: '1px solid rgba(3,194,195,0.15)', borderRight: '1px solid rgba(3,194,195,0.15)' }}>
                <span className="text-base flex-shrink-0" style={{ color: '#03C2C3' }}>✓</span>
          ...
          {comparisons.map((row, i) => (
            <div key={i} className="rounded-2xl overflow-hidden" style={{ border: '1px solid rgba(255,255,255,0.07)' }}>
              ...
              <div className="grid grid-cols-2">
                <div className="px-4 py-3 flex flex-col gap-1" style={{ background: 'rgba(3,194,195,0.05)', borderRight: '1px solid rgba(3,194,195,0.15)' }}>
                  <p className="text-[10px] font-bold uppercase tracking-widest mb-1" style={{ color: '#03C2C3' }}>Fibra Siga</p>
                  <div className="flex items-start gap-1.5">
                    <span className="flex-shrink-0 mt-0.5 text-xs" style={{ color: '#03C2C3' }}>✓</span>
            ...
            <div key={i} className="relative">
              {i < steps.length - 1 && (
                <div
                  ...
                  style={{ background: 'linear-gradient(90deg, rgba(3,194,195,0.4), rgba(3,194,195,0.05))', width: 'calc(100% - 2.5rem)', left: '80%' }}
                />
              )}
              <div
              ...
              >
                <div
                  ...
                  style={{ background: 'linear-gradient(135deg, #3ddcde 0%, #03C2C3 100%)', color: '#062a2a' }}
                >
                  {step.n}
                </div>
